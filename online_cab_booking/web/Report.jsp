  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <div class="box" >
            ...
            <h1>Reports</h1>
        <input type="submit" class="button" value="completed_journey" name="submit">
        <br>
        
         <input type="submit" class="button" value="pending journey" name="submit">
         <br>
         
          <input type="submit" class="button" value="Driver List" name="submit">
          <br>
           <input type="submit" class="button" value="User_List" name="submit">
           <br>
           
            <input type="submit" class="button" value="Payment Reset" name="submit">
